 ...
 *
 */
public class PatientSection implements java.io.Serializable{
	...
	private Set<PatientTopic> topices = new HashSet<PatientTopic>();//该版块下所属的主题
	...
	public Set<PatientTopic> getTopices() {
		return topices;
	}
	public void setTopices(Set<PatientTopic> topices) {
